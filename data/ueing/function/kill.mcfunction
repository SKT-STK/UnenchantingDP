...
summon item ~ ~ ~ {Item:{id:"minecraft:strider_spawn_egg",components:{entity_data:{id:"minecraft:marker",Tags:["ueing.marker","ueing.no_minecarts"]},item_name:'"Unenchanting Table"',item_model:"minecraft:enchanting_table"}}}
