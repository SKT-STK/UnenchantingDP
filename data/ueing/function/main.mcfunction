...
execute as @e[tag=ueing.minecart,tag=ueing.after] unless data entity @s Items[{Slot:3b}] unless data entity @s Items[{Slot:4b}] run function ueing:swap_tags_to_before
